...
const Navbar = () => {
  ...
  return (
    <div className='flex items-center justify-between px-5 cursor-pointer sticky top-0 bg-white shadow z-10 h-14' >
      ...
      <div>
        <NavLink to="/listings/new" className="text-md md:text-lg font-semibold text-slate-800 hover:text-slate-600 hover:underline underline-offset-3 px-4 py-1 rounded-md mr-3">
            Create Listing
          </NavLink>
        {user.isAuthorized ? (
